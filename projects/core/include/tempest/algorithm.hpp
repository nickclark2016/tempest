...
namespace tempest::core
{
    ...
    {
        template <typename Fn> inline static constexpr void evaluate(Fn f)
        {
            f(StartIdx);
    ...
    template <auto Start, auto End, auto StepSize, typename Fn> inline constexpr void unroll_loop(Fn f)
    {
        ...
        loop_unroller<decltype(Start), Start, static_cast<decltype(Start)>(End), static_cast<decltype(Start)>(StepSize)>::evaluate(f);
    }
} // namespace tempest::core
