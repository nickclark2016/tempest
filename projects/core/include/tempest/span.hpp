...
namespace tempest::core
{
    ...
    template <typename T, std::size_t Extent>
    template <typename U, std::size_t N>
    inline constexpr span<T, Extent>::span(std::array<U, N>& arr) noexcept : _start{arr.data()}, _end{arr.data() + N}
    {
    }

    template <typename T, std::size_t Extent>
    template <typename U, std::size_t N>
    inline constexpr span<T, Extent>::span(const std::array<U, N>& arr) noexcept
