...
newaction {
    ...
    execute = function()
        local web_dir = path.join(_MAIN_SCRIPT_DIR, 'engine/runtime/profiler/web')
        local out_file = path.join(_MAIN_SCRIPT_DIR, 'engine/runtime/profiler/src/web_assets.cpp')
        ...
        local current = read_file(out_file)
