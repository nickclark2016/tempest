...
namespace tempest::render_system
{
    ...
    {
        return graph.add_graphics_pass<frame_upload_pass_data>(
            "FrameUploadPass",
            [&pool](render_graph::pass_builder& builder, frame_upload_pass_data& data) {
                ...
                builder.write(data.scene_constants, rhi::pipeline_stage::top_of_pipe, rhi::resource_access::write);
                builder.write(data.object_buffer, rhi::pipeline_stage::top_of_pipe, rhi::resource_access::write);
                builder.write(data.instance_buffer, rhi::pipeline_stage::top_of_pipe, rhi::resource_access::write);
                builder.write(data.draw_commands, rhi::pipeline_stage::top_of_pipe, rhi::resource_access::write);
            },
            []([[maybe_unused]] const frame_upload_pass_data& data,
               ...
               [[maybe_unused]] rhi::command_list& cmd) {
                ...
                // This pass establishes DAG buffer readiness and pipeline barriers for downstream passes on the graphics queue.
            });
    }
} // namespace tempest::render_system
