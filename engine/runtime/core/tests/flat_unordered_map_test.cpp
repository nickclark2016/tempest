...
TEST(metadata_group, any_empty_one_empty)
{
    ...
    group.entries[0] = tempest::detail::empty_entry;
...
TEST(metadata_group, any_empty_one_deleted)
{
    ...
    group.entries[0] = tempest::detail::deleted_entry;
...
TEST(metadata_group, match_byte_none)
{
    ...
    EXPECT_EQ(group.match_byte(tempest::detail::empty_entry), 0);
}
...
{
    tempest::flat_unordered_map<int, int> map;
