...
namespace tempest::graphics
{
    ...
    auto camera_system::get_active_camera_entity() const -> tempest::optional<ecs::entity>
    {
        ...
        // 1. Check if tracked active camera entity is still valid and tagged with active_camera_component and camera_component
        ...
        // 2. Search for any entity with active_camera_component and camera_component
        ...
        // 3. Fall back to first entity with camera_component and transform_component
    ...
    auto camera_system::set_active_camera(ecs::entity camera_entity) -> void
    {
        ...
        {
            _registry->assign<active_camera_component>(camera_entity, active_camera_component{});
        }
    }
} // namespace tempest::graphics
