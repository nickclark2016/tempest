scoped.project('editor-core', function()
    ...
    scoped.filter({ 'files:shaders/**.slang' }, function()
        ...
        scoped.filter({
            ...
            buildcommands {
                '%{!fetch.slang.compiler} %{!file.abspath} -target spirv -capability SPIRV_1_5 -fvk-use-entrypoint-name -o %{!wks.basedir}/assets/shaders/editor/%{file.basename}.vert.spv -entry VSMain -O3 -g3',
                '%{!fetch.slang.compiler} %{!file.abspath} -target spirv -capability SPIRV_1_5 -fvk-use-entrypoint-name -o %{!wks.basedir}/assets/shaders/editor/%{file.basename}.frag.spv -entry FSMain -O3 -g3',
            }
        end)
